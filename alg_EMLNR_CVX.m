function out=alg_EMLNR_CVX(net)
%% INFORMATION

% DESCRIPTION: implemnts using CVX the EML method (Problem (6)) described in https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=6725647&tag=1 

function Network=scaleNet(net,scf,sigma)
%% INFORMATION

% DESCRIPTION: changes the boundaries of a given network to scf*[-1/2,1/2]

% INPUTS:
% * net - network structure
% * scf - the scaling factor
